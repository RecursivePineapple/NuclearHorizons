/**
 * Originally from the Ic2 Reactor Planner at https://github.com/GTNewHorizons/Ic2ExpReactorPlanner
 */
...
public class BigintStorage {
    ...
    public void store(int value, int max) {
        ...
        storedValue = storedValue.multiply(BigInteger.valueOf(max + 1))
    ...
    public boolean isEmpty() {
        return storedValue.equals(BigInteger.ZERO);
    }
}
