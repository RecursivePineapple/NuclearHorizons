...
public class ChemicalReactor {
    ...
    public void run() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialsNuclear.URANIUM_235_DIOXIDE.get(OrePrefixes.dust, 3), Materials.Sodium.getDust(4))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialsNuclear.URANIUM_233_DIOXIDE.get(OrePrefixes.dust, 3), Materials.Sodium.getDust(4))
            .fluidInputs(Materials.HydrofluoricAcid.getFluid(4000))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialsNuclear.URANIUM_238_DIOXIDE.get(OrePrefixes.dust, 3), Materials.Sodium.getDust(4))
            .fluidInputs(Materials.HydrofluoricAcid.getFluid(4000))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialsNuclear.PLUTONIUM_241_DIOXIDE.get(OrePrefixes.dust, 3), Materials.Calcium.getDust(2))
            .fluidInputs(Materials.HydrofluoricAcid.getFluid(4000))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(MaterialsNuclear.PLUTONIUM_239_DIOXIDE.get(OrePrefixes.dust, 3), Materials.Calcium.getDust(2))
            .fluidInputs(Materials.HydrofluoricAcid.getFluid(4000))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTOreDictUnificator.get(OrePrefixes.dust, Materials.Uraninite, 3))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(Materials.Cobalt.getDustTiny(1))
            .fluidInputs(
            ...
            .fluidOutputs(MaterialsNuclear.TRIBUTYL_PHOSPHATE.getFluidOrGas(1000), Materials.CarbonDioxide.getGas(3000))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_HV)
            .addTo(multiblockChemicalReactorRecipes);
    }
